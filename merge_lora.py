...
def merge_lora_adapter(base_model_name, adapter_path, output_path):
    ...
    try:
        ...
        base_model = AutoModelForCausalLM.from_pretrained(base_model_name, torch_dtype=compute_dtype, trust_remote_code=True, device_map="auto")  # Load onto available device
