...
def main(model_dir, output_file, llama_cpp_dir="llama.cpp", out_type="f16"):
    ...
    possible_scripts = [llama_cpp_path / "convert_hf_to_gguf.py", llama_cpp_path / "convert.py", *list(llama_cpp_path.glob("**/convert_hf_to_gguf.py")), *list(llama_cpp_path.glob("**/convert.py"))]
